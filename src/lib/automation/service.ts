...
async function readGuardrailDecision(
  ...
  if (
    ...
    if (settings.limit_behavior === "alert") {
      return {
        allowed: true,
        note: "Daily automation 0G limit reached.",
      };
    }
    ...
    return {
      allowed: false,
      pauseTask: true,
      reason: "Daily automation 0G limit reached.",
    };
  }
  ...
  if (
    ...
    if (settings.limit_behavior === "alert") {
      return {
        allowed: true,
        note: "Monthly automation 0G cap reached.",
      };
    }
    ...
    return {
      allowed: false,
      pauseTask: true,
      reason: "Monthly automation 0G cap reached.",
    };
  }
  ...
  if (
    ...
    return {
      allowed: false,
      pauseTask: true,
      reason: "0G balance is below the automation threshold.",
    };
  }
